...
const classNames= require('../opencv/others/dnnCocoClassNames')
...
const classifyImg = (img) => {
  ...
  console.log("start Image Analyse Multi COCO ssd")
  ...
  return results.filter((x) => x.confidence > 0.1).sort((a,b)=>b.confidence - a.confidence);
};
